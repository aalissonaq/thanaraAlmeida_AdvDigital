        ...
        <table id="tabela" class="table table-sm table-striped table-hover">
          <thead class="" style="font-family: 'Advent Pro', sans-serif;">
            <tr>
              ...
              <th class="col-md-auto text-center align-middle">E-MAIL</th>
              ...
              <tr>
                <td class="text-center align-middle">
                  ...
                  <img src="<?php
                            ...
                            ?>" alt="<?php echo $dados['nmPessoa'] ?>" width="60px" height="60px" class="img-circle img-fluid">
                </td>
                      ...
                      case '0':
                        ...
                        "
                                        <li class=\"nav-item\">
                                          ...
                                          <li class=\"nav-item\">
                                          <a href=\"?page=edtCliente&idEdit={$dados['idPassoaPessoa']}\" class=\"btn btn-tool\" target=\"\"
                                          title=\"Editar Dados\" rel=\"noopener noreferrer\" >
                                          ...
                                          <li class=\"nav-item\">
                                            ...
                                            title=\"Ver Processos\" rel=\"noopener noreferrer\">
                                              <!-- <i class=\"fas fa-pen fa-lg\"></i> -->
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" style="font-family: 'Advent Pro', sans-serif; font-weight: 500; letter-spacing: 1px; color:orange">Novo Cliente</h4>
        ...
        <form class="needs-validation" novalidate action="./pages/pages/acoes/gravaNovoCliente.php" method="POST" enctype="multipart/form-data">
          <div class="form-row">
            <div class="col-md-6 mb-3 ">
              <label for="nmPessoa">Nome do Cliente <span style="color:var(--orange)">*</span></label>
            ...
            <div class="col-md-2 mb-3">
              <label for="docPessoa">CPF <span style="color:var(--orange)"> *</span></label>
          ...
          <div class="form-row">
            <div class="col-md-2 mb-3">
              <label for="dtNascPessoa">Data de Nascimento<span style="color:var(--orange)"> *</span></label>
            ...
            <div class="col-md-2 mb-3">
              <label for="sexoCliente">Sexo<span style="color:var(--orange)"> *</span></label>
            ...
            <div class="col-md-3 mb-3">
              <label for="strNaturalidadeCliente">Naturalidade<span style="color:var(--orange)"> *</span></label>
            ...
            <div class="col-md-12 mb-3">
              <label for="nmMae">Nome da Mãe<span style="color:var(--orange)"> *</span></label>
          ...
          <div class="form-row">
            ...
            <div class="col-md-8 mb-3">
              <label for="stLogradouroPessoa">Endereço<span style="color:var(--orange)"> *</span> </label>
            ...
            <div class="col-md-2 mb-3">
              <label for="nnCasaPessoa">Nº<span style="color:var(--orange)"> *</span></label>
          ...
          <div class="form-row">
            ...
            <div class="col-md-4 mb-3">
              <label for="stBairroPessoa">Bairro<span style="color:var(--orange)"> *</span></label>
            ...
            <div class="col-md-3 mb-3">
              <label for="stCidadePessoa">Cidade<span style="color:var(--orange)"> *</span></label>
            ...
            <div class="col-md-1 mb-3">
              <label for="stEstadoPessoa">UF<span style="color:var(--orange)"> *</span></label>
          ...
          <div class="form-row">
            <div class="col-md-3 mb-3">
              <label for="nnTelefonePessoa">Telefone<span style="color:var(--orange)"> *</span></label>
          ...
          <div class="form-row">
            <div class="col-md-12 mb-3">
              <label for="nnTelefonePessoa">Foto/Logo do Cliente<span style="color:var(--orange)"> *</span></label>
