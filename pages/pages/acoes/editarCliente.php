...
if (isset($_POST['gravar']) && $_POST['gravar'] == 'gravar') {
  ...
  $cliente['sexoCliente'] = strip_tags((trim($_POST['sexoCliente'])));
  $cliente['strEstadoCivilCliente'] = strip_tags((trim($_POST['strEstadoCivilCliente'])));
  $cliente['strNaturalidadeCliente'] = strip_tags((trim($_POST['strNaturalidadeCliente'])));
  $cliente['nnRg'] = strip_tags((trim(strtoupper($_POST['nnRg']))));
  $cliente['nmMae'] = strip_tags((trim(strtoupper($_POST['nmMae']))));
  $cliente['nmPai'] = strip_tags((trim(strtoupper($_POST['nmPai']))));
  $cliente['nmResponsavel'] = strip_tags((trim(strtoupper($_POST['nmResponsavel']))));
